...
const getSubject = (_canvases, args) => new CanvasWorld(_canvases, { miradorConfig: miradorConfigSlice(), ...args });
...
describe('CanvasWorld', () => {
  ...
  describe('contentResourceToWorldCoordinates', () => {
    ...
    it('supports RTL orientations', () => {
      expect(getSubject(canvasSubset, { layers: null, viewingDirection: 'right-to-left' }).contentResourceToWorldCoordinates({ id: 'https://stacks.stanford.edu/image/iiif/rz176rt6531%2FPC0170_s3_Tree_Calendar_20081101_152516_0410/full/full/0/default.jpg' }))
        .toEqual([0, 0, 2848, 4288]);
    });
    it('supports TTB orientations', () => {
      expect(getSubject(canvasSubset, { layers: null, viewingDirection: 'top-to-bottom' }).contentResourceToWorldCoordinates({ id: 'https://stacks.stanford.edu/image/iiif/rz176rt6531%2FPC0170_s3_Tree_Calendar_20081101_152516_0410/full/full/0/default.jpg' }))
        .toEqual([0, 1936, 2848, 4288]);
    });
    it('supports BTT orientations', () => {
      expect(getSubject(canvasSubset, { layers: null, viewingDirection: 'bottom-to-top' }).contentResourceToWorldCoordinates({ id: 'https://stacks.stanford.edu/image/iiif/rz176rt6531%2FPC0170_s3_Tree_Calendar_20081101_152516_0410/full/full/0/default.jpg' }))
        .toEqual([0, 0, 2848, 4288]);
    });
  ...
  describe('canvasToWorldCoordinates', () => {
    ...
    it('supports RTL orientations', () => {
      expect(getSubject(canvasSubset, { layers: null, viewingDirection: 'right-to-left' }).canvasToWorldCoordinates('https://purl.stanford.edu/rz176rt6531/iiif/canvas/rz176rt6531_1'))
        .toEqual([0, 0, 2848, 4288]);
    });
  });
